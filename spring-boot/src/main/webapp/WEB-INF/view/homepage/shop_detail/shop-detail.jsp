                            ...
                            <div class="navbar-nav mx-auto">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                        <a href="/pages/cart" class="dropdown-item">Cart</a>
                                        <a href="/pages/checkout" class="dropdown-item">Checkout</a>
                                        <a href="/pages/testimonial" class="dropdown-item">Testimonial</a>
                                        <a href="/pages/404" class="dropdown-item">404 Page</a>
                                    </div>
                                </div>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="border rounded">
                                        <a href="#">
                                            <img src="homepage/img/single-item.jpg" class="img-fluid rounded"
                                                alt="Image">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="tab-content mb-5">
                                        ...
                                        <div class="tab-pane" id="nav-mission" role="tabpanel"
                                            ...
                                            <div class="d-flex">
                                                <img src="homepage/img/avatar.jpg" class="img-fluid rounded-circle p-3"
                            ...
                            <div class="row g-4 fruite">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="d-flex align-items-center justify-content-start">
                                        <div class="rounded" style="width: 100px; height: 100px;">
                                            <img src="homepage/img/featur-1.jpg" class="img-fluid rounded" alt="Image">
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-start">
                                        <div class="rounded" style="width: 100px; height: 100px;">
                                            <img src="homepage/img/featur-2.jpg" class="img-fluid rounded" alt="">
                                        </div>
                                        <div>
                                            <h6 class="mb-2">Big Banana</h6>
                                            <div class="d-flex mb-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-start">
                                        <div class="rounded" style="width: 100px; height: 100px;">
                                            <img src="homepage/img/featur-3.jpg" class="img-fluid rounded" alt="">
                                        </div>
                                        <div>
                                            <h6 class="mb-2">Big Banana</h6>
                                            <div class="d-flex mb-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-start">
                                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                                            <img src="homepage/img/vegetable-item-4.jpg" class="img-fluid rounded"
                                                alt="">
                                        </div>
                                        <div>
                                            <h6 class="mb-2">Big Banana</h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-start">
                                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                                            <img src="homepage/img/vegetable-item-5.jpg" class="img-fluid rounded"
                                                alt="">
                                        </div>
                                        <div>
                                            <h6 class="mb-2">Big Banana</h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-start">
                                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                                            <img src="homepage/img/vegetable-item-6.jpg" class="img-fluid rounded"
                                                alt="">
                                        </div>
                                        <div>
                                            <h6 class="mb-2">Big Banana</h6>
                                ...
                                <div class="col-lg-12">
                                    <div class="position-relative">
                                        <img src="homepage/img/banner-fruits.jpg" class="img-fluid w-100 rounded"
                                            alt="">
                        ...
                        <div class="owl-carousel vegetable-carousel justify-content-center">
                            <div class="border border-primary rounded position-relative vesitable-item">
                                <div class="vesitable-img">
                                    <img src="homepage/img/vegetable-item-6.jpg" class="img-fluid w-100 rounded-top"
                                        alt="">
                                </div>
                            ...
                            <div class="border border-primary rounded position-relative vesitable-item">
                                <div class="vesitable-img">
                                    <img src="homepage/img/vegetable-item-1.jpg" class="img-fluid w-100 rounded-top"
                                        alt="">
                                </div>
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                    style="top: 10px; right: 10px;">Vegetable</div>
                            ...
                            <div class="border border-primary rounded position-relative vesitable-item">
                                <div class="vesitable-img">
                                    <img src="homepage/img/vegetable-item-4.jpg" class="img-fluid w-100 rounded-top"
                                        alt="">
                                </div>
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                    style="top: 10px; right: 10px;">Vegetable</div>
                            ...
                            <div class="border border-primary rounded position-relative vesitable-item">
                                <div class="vesitable-img">
                                    <img src="homepage/img/vegetable-item-5.jpg" class="img-fluid w-100 rounded-top"
                                        alt="">
                                </div>
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                    style="top: 10px; right: 10px;">Vegetable</div>
