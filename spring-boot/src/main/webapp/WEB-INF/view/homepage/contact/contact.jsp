                            ...
                            <div class="navbar-nav mx-auto">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                        <a href="/pages/cart.html" class="dropdown-item">Cart</a>
                                        <a href="/pages/checkout.html" class="dropdown-item">Chackout</a>
                                        <a href="/pages/testimonial.html" class="dropdown-item">Testimonial</a>
                                        <a href="/pages/404.html" class="dropdown-item">404 Page</a>
                                    </div>
                                </div>
